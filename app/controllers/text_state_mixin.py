...
class TextStateMixin:
    ...
    def _mirror_target_snapshot_to_viewer_state(self, state: dict, target_lang: str) -> dict:
        target_snapshot = get_target_snapshot(
            state,
            target_lang,
    ...
    def _sync_current_render_snapshot(
        self,
        file_path: str | None = None,
        *,
        update_style_overrides: bool = False,
    ) -> None:
    ...
    def save_src_trg(self):
        ...
        self.main.image_ctrl.save_current_image_state(target_lang=previous_target or None)
        ...
        for image_path in self.main.image_files:
            ...
            if state is not None:
                ...
                if target_lang in target_render_states:
                    state["viewer_state"] = copy.deepcopy(
                        get_target_snapshot(
                            state,
                            target_lang,
                            fallback_to_viewer_state=False,
