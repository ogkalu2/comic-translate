...
class TextFormatCommand(QUndoCommand, RectCommandBase):
    ...
    def redo(self):
        ...
        if matching_item:
            matching_item.set_text(self.new_html, self.new_item_prp.width, preserve_source_text=True)
    ...
    def undo(self):
        ...
        if matching_item:
            matching_item.set_text(self.old_html, self.old_item_prp.width, preserve_source_text=True)
