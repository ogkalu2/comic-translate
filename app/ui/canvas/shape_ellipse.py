"""
Implementazione della forma Ellisse per il canvas.
"""
...
class EllipseItem(ShapeItem):
    """
    Elemento ellittico disegnabile nel canvas.
    ...
    def paint(self, painter, option, widget):
        """Disegna l'ellisse con lo stile corrente"""
        # Disegna l'ellisse
    ...
    def _resize_by_handle(self, mouse_pos, handle):
        """Ridimensiona l'ellisse in base all'handle selezionato"""
