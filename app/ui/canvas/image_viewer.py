...
class ImageViewer(QGraphicsView):
    ...
    def add_text_item(self, properties) -> TextBlockItem:
        ...
        item = TextBlockItem(
            ...
            second_outline=properties.second_outline,
            second_outline_color=properties.second_outline_color,
            second_outline_width=properties.second_outline_width,
            text_gradient=properties.text_gradient,
            text_gradient_start_color=properties.text_gradient_start_color,
            text_gradient_end_color=properties.text_gradient_end_color,
