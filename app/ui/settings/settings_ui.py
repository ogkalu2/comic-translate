...
class SettingsPageUI(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.credential_services = [self.tr("Deepseek v3"), self.tr("Open AI GPT"), self.tr("Microsoft Azure"), self.tr("Google Cloud"), 
                                    self.tr("Google Gemini"), self.tr("DeepL"), self.tr("Anthropic Claude"), self.tr("Yandex")]
        
        self.supported_translators = [self.tr("Deepseek-v3"), self.tr("GPT-4o"), self.tr("GPT-4o mini"), self.tr("DeepL"), 
        ...
        self.value_mappings = {
            ...
            # Translator mappings
            self.tr("Deepseek-v3"): "Deepseek-v3", # add Deepseek
